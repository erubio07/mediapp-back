...
const {
  generateActaCierre,
} = require ("../controllers/fillContracts/fillActaCierre");
...
const fillActaCierre = async (req, res) => {
  try {
    // Obtener datos del request
    const data = req.body;

    // Generar el documento
    const generatedDocument = generateActaCierre(data);
...
module.exports = { fillTemplateHandler, fillActaAudiencia, fillActaCierre };
